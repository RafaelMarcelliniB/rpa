...
class InformeInspeccionValidator:
    ...
    def __init__(self):
        self.estructura_informe = {
            "secciones_obligatorias": [
                ...
                "METODOLOGIA EMPLEADA PARA LA INSPECCION",
                "UBICACIÓN Y ACCESOS",
                "UBICACION Y ACCESOS",
    ...
    def validate_pdf(self, pdf_path: str) -> Dict:
        ...
        print(f"\n{'='*80}")
        print(f"VALIDACIÓN DEL INFORME TÉCNICO DE INSPECCIÓN OCULAR")
        print(f"{'='*80}")
        ...
        print("Validando Informe Técnico de Inspección Ocular...\n")
        ...
        report = {
            "metadata": {
                ...
                "componente": "INFORME TÉCNICO DE INSPECCIÓN OCULAR",
    ...
    def _generate_observations(self, result: ValidationResult) -> List[str]:
        ...
        if result.warnings:
            observations.extend(result.warnings)
    ...
    def export_report_txt(self, report: Dict, output_path: str = "reporte_inspeccion_ocular.txt"):
        ...
        try:
            with open(output_path, 'w', encoding='utf-8') as f:
                ...
                f.write("INFORME TÉCNICO DE INSPECCIÓN OCULAR\n")
                f.write("="*80 + "\n\n")
    ...
    def export_report_pdf(self, report: Dict, output_path: str = "reporte_inspeccion_ocular.pdf"):
        """Exporta reporte a formato PDF profesional - BASADO EN REFERENCIA"""
        try:
            ...
            # ====================
            # PORTADA (Siguiendo formato de referencia)
            # ====================
            story.append(Spacer(1, 1.2*inch))
            
            title = Paragraph("REPORTE DE VALIDACIÓN<br/>INFORME TÉCNICO DE INSPECCIÓN OCULAR", title_style)
            story.append(title)
            ...
            summary_text = f"""
            El presente reporte detalla la validación del Informe Técnico de Inspección Ocular 
            ...
            # Tabla de detalle de secciones (como en referencia)
            ...
            # Resumen estadístico (como en referencia)
            ...
            if meta['estado'] == 'APROBADO':
                conclusion = """
                El Informe Técnico de Inspección Ocular <b>CUMPLE</b> con todos los requisitos 
                ...
                conclusion = f"""
                El Informe Técnico de Inspección Ocular presenta <b>{num_faltantes} sección(es) 
...
def main():
    ...
    print("\n" + "="*80)
    print("RPA - VALIDADOR DE INFORME TÉCNICO DE INSPECCIÓN OCULAR")
    ...
    if len(sys.argv) < 2:
        ...
        print("\nEjemplo:")
        print("  python rpa_inspeccion_ocular.py informe_inspeccion.pdf")
        return
